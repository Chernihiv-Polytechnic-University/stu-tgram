...
const getKeyboardByTUserStatus = (status: TelegramUserStatus) => {
  const mapper = {
    [TelegramUserStatus.unknown]: ['whatIsLesson', 'schedule', 'questionAnswer', 'letsGetAcquainted', 'whyIShouldGetAcquainted', 'aboutBot'],
    [TelegramUserStatus.partialKnown]: ['whatIsLesson', 'schedule', 'questionAnswer', 'letsGetAcquainted', 'whyIShouldGetAcquainted', 'aboutBot'],
    [TelegramUserStatus.fullKnown]: ['whatIsLesson', 'schedule', 'questionAnswer', 'requests', 'settings', 'feedback', 'aboutBot'],
  }
